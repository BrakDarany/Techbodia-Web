...
const jobData: IJobDetail[] = [
  ...
  },
  {
    ...
    jobRequirement: [
      'Develop and maintain web applications and services using C#, Vue.js with Nuxt, Tailwind CSS, and Element UI.',
      'Work on APIs, caching layers using Redis, and UI components.',
      'Ensure cross-platform compatibility and responsive design.',
      'Write clean, maintainable, and efficient code following best practices.',
      'Debug complex issues and optimize application performance.',
      'Conduct manual and automated testing to ensure application reliability.',
      'Identify, document, and resolve bugs or performance issues.',
      'Collaborate with product owners, designers, and IT teams.',
      'Participate actively in Agile Scrum processes including sprints and retrospectives.',
      'Deploy applications on IIS servers and Kubernetes (K8S) clusters.',
      'Monitor system performance, scalability, and uptime.',
      'Maintain clear and up-to-date technical documentation.',
      'Stay updated with the latest trends in C#, Vue.js, and cloud-based deployments.',
    ],
    jobResponsible: [
      "Bachelor's degree in Computer Science, Information Technology, or a related field (or equivalent experience).",
      'Strong expertise in C# and .NET Core.',
      'Proficiency in Vue.js with Nuxt.',
      'Hands-on experience with Tailwind CSS and Element UI.',
      'Experience using Redis for caching.',
      'Strong understanding of RESTful APIs and web standards.',
      'Basic knowledge of Kubernetes (K8S) and Docker (plus).',
      'Experience deploying applications on IIS servers.',
      'Familiarity with Agile/Scrum development processes.',
      'Understanding of microservices architecture (nice to have).',
      ...
      'Excellent communication skills and strong teamwork mindset.',
    ],
  },
  {
  ...
  },
  {
    ...
    jobResponsible: [
      ...
      '有客戶支援或類似職位經驗者優先.',
      '了解所支援的軟體或類似軟體產品.',
      '能夠在快節奏的環境中工作並同時處理多項任務.',
      '熟悉專案系 統，例如 YouTrack 和 JIRA.',
      '對軟體技術有基本的了解.',
      '處理具有挑戰性的情況或客戶時具有高度的耐心和專業精神.',
      'Bonus point 加分項目',
      '技術相關領域的技術背景或學位',
      '擁有軟體公司或技術相關產業的經驗',
      '精通多種語言',
